...
namespace laboratoryWorkers
{
    public class DataGridViewPrinter
    {
        ...
        public static void printInfo(DataGridView dataGridView)
        {
            ...
            printDocument.DocumentName = "Сотрудники лаборатории";
            ...
            DataGridViewPrinter MyDataGridViewPrinter = new DataGridViewPrinter
                                                            (dataGridView,
                                                             printDocument,
                                                             true,
                                                             true,
                                                             "Сотрудники лаборатории",
                                                             new Font("Tahoma", 8, FontStyle.Bold, GraphicsUnit.Point), Color.Black, true);

            printDocument.PrintPage += (object obj, PrintPageEventArgs ev) =>
            {
                bool more = MyDataGridViewPrinter.DrawDataGridView(ev.Graphics);
                if (more == true) ev.HasMorePages = true;
            };
